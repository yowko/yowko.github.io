    ...
    - 解決方式：使用 Singleton 或 static 方式建立 HttpClient 物件
        ...
        - Singleton
            - ~~double-check locking~~
                ...
                > 經黑大提醒，重新閱讀 [Implementing the  Singleton Pattern in C#](http://csharpindepth.com/articles/general/singleton.aspx) : 作者建議 不要使用 `double-check locking` ，建議作法使用  `Lazy<T>`
